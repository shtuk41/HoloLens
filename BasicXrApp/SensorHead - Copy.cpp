...
#define CUBE_SIDE(V1, V2, V3, V4, V5, V6, COLOR) {V1, COLOR}, {V2, COLOR}, {V3, COLOR}, {V4, COLOR}, {V5, COLOR}, {V6, COLOR},
    ...
    struct SensorHeadGraphics : sample::IGraphicsPluginD3D11 {
        ...
        void InitializeD3DResources() 
        {
            ...
            const winrt::com_ptr<ID3DBlob> pixelShaderBytes = sample::dx::CompileShader(SensorHeadShader::ShaderHlsl, "MainPS", "ps_5_0");
            ...
            // const D3D11_SUBRESOURCE_DATA vertexBufferData{SensorHeadShader::c_sensorHeadVertices};
            // const CD3D11_BUFFER_DESC vertexBufferDesc(sizeof(SensorHeadShader::c_sensorHeadVertices), D3D11_BIND_VERTEX_BUFFER);
            // CHECK_HRCMD(m_device->CreateBuffer(&vertexBufferDesc, &vertexBufferData, m_sensorHeadVertexBuffer.put()));
            ...
            // const D3D11_SUBRESOURCE_DATA indexBufferData{SensorHeadShader::c_sensorHeadIndices};
            // const CD3D11_BUFFER_DESC indexBufferDesc(sizeof(SensorHeadShader::c_sensorHeadIndices), D3D11_BIND_INDEX_BUFFER);
            // CHECK_HRCMD(m_device->CreateBuffer(&indexBufferDesc, &indexBufferData, m_sensorHeadIndexBuffer.put()));
